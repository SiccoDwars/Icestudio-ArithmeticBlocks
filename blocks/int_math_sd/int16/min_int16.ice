    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "// y = min (a,b), 16 bits integers\n\nassign y = ($signed(a) < $signed(b)) ? a : b;\n",
            "params": [],
            "ports": {
              "in": [
                {
